...
import { register, loginWithGoogle, loginWithFacebook } from '../utils/AuthFunctions';
import { Eye, EyeOff, Mail, Lock, User, Film, Play, Star } from 'lucide-react';
...
const RegisterPage = () => {
    ...
    const handleGoogleRegister = () => {
        try {
            ...
            console.error("Google registration failed to initiate:", error);
    ...
    const handleFacebookRegister = () => {
        try {
            loginWithFacebook(); // This will redirect to Facebook
        } catch (error) {
            console.error("Facebook registration failed to initiate:", error);
            setError("Failed to initiate Facebook registration. Please try again.");
        }
    };
            ...
            <div className="relative z-10 w-full max-w-md">
                ...
                >
                    ...
                    <p className="mt-8 text-center text-sm text-gray-400">
                        ...
                        <Link to="/login" className="font-medium cursor-pointer text-purple-400 hover:text-purple-300 transition-colors duration-200">
                            Login now
                        </Link>
                    </p>
                </div>
